...
namespace StorageQueueApp
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            string connectionString = "DefaultEndpointsProtocol=https;EndpointSuffix=core.windows.net;AccountName=articles01905389;AccountKey=WYwrVrF3pVm/LqJ84NQN8QU4RE0X04qP1yti068HDO+Lpf48hzeTU1c4Qy8t8icb9+wrSmQu2tnnzbrVVPv34A==";
